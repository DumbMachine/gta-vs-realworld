...
def load_voc_instances(dirname: str, split: str):
    """
    Load humans VOC detection annotations to Detectron2 format.
...
def register_humans_voc(name, dirname, split):
...
if __name__ == "__main__":
    ...
    dataset_name = f"humans_{args.split}"
    register_humans_voc(dataset_name, "datasets/humans", args.split)
